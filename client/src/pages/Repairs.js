                ...
                <div className="row">
                    <div className="col-xl-4">
                        ...
                        <div className="card">
                            ...
                            <img src={NoImageAvailable} alt="Profile" className="rounded-left" />
                            ...
                            <div className="card-body pt-3">
                                <ul className="nav nav-tabs nav-tabs-bordered">
                                    ...
                                    <li className="nav-item">
                                        <button className="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">Parts Replacement</button>
                                    </li>

                                    <li className="nav-item">
                                        <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Engine And Transmission</button>
                                    </li>


                                    <li className="nav-item">
                                        <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password">Interior</button>
                                    </li>

                                    <li className="nav-item">
                                        <button className="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password">Extreior</button>
                                    </li>
